...
import boba_python_utils.time_utils
from boba_python_utils.general_utils.console_util import hprint_message

from boba_python_utils.time_utils.iter_dates import iter_dates
from boba_python_utils.time_utils.common import solve_datetime
...
def next_available_path_with_year_month_day(
    ...
    for date in boba_python_utils.time_utils.iter_dates.iter_dates(
