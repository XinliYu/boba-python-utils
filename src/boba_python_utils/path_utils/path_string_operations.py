...
from boba_python_utils.string_utils.comparison import string_check
from boba_python_utils.string_utils.prefix_suffix import add_suffix
from boba_python_utils.time_utils.common import timestamp
...
def abspath_(pathstr: str) -> str:
    ...
    to the full user directory path. This function differs from `os.path.abspath` in that it performs this
    expansion.
